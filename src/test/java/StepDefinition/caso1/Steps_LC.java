...
public class Steps_LC {
	...
	public void ingresar_Username_y_Password(String string, String string2) throws InterruptedException{
		System.out.println("Se ingresa el nombre de usuario y contraseña correctos");
	...
	public void inicia_sesion() throws InterruptedException{
		System.out.println("Se inicia sesion con los datos ingresados desde nuestro archivo LC.feature");
